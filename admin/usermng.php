...
?>
        <div id="container">
            <div class="header">
                <img style="margin:10px 2px 2px 10px;float:left;" height="130" width="1366" src="../images/logo.png" alt="OES"/><h3 class="headtext">  </h3><h4 style="color:#ffffff;text-align:center;margin:0 0 5px 5px;">
            </div>
...
?>
                        <input type="submit" value="Cancel" name="cancel" class="subbtn" title="Cancel"/> 
                         <input type="submit" value="Save" name="savea" class="subbtn" onclick="validateform('usermng')" title="Save the Changes"/> 

<?php
    } else if (isset($_REQUEST['edit'])) { //navigation for Edit option
?>
                         <input type="submit" value="Cancel" name="cancel" class="subbtn" title="Cancel"/> 
                         <input type="submit" value="Save" name="savem" class="subbtn" onclick="validateform('usermng')" title="Save the changes"/> 

<?php
    } else {  //navigation for Default
?>
                         <input type="submit" value="Delete" name="delete" class="subbtn" title="Delete"/> 
...
<?php
                    while ($r = mysql_fetch_array($result)) {
                        ...
                        . "<td class=\"tddata\"><a title=\"Edit " . htmlspecialchars_decode($r['stdname'], ENT_QUOTES) . "\"href=\"usermng.php?edit=" . htmlspecialchars_decode($r['stdname'], ENT_QUOTES) . "\"><img src=\"../images/edit.jpg\" height=\"30\" width=\"40\" alt=\"Edit\" /></a></td></tr>";
                    }
?>
                    </table>
<?php
